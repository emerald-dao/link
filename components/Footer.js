  ...
  return (
    <footer className="m-auto mt-60 max-w-[920px] flex flex-1 justify-center items-center py-8 border-t border-solid box-border">
      <div className="flex flex-col gap-y-2 items-center">
        ...
        >
          Made by <span className="underline font-bold decoration-emerald decoration-2">33Labs</span> with ❤️
        </a>
        <a
          ...
          className="font-flow text-sm whitespace-pre"
        >
           Get support on <span className="underline font-bold decoration-emerald decoration-2">Emerald City DAO</span>
        </a>
      </div>
